...
class ServerstatsPlugin(octoprint.plugin.SettingsPlugin,
	...
	def get_assets(self):
		...
		# core UI here.
		return dict(
			js=["js/ServerStats.js"],
			css=["css/ServerStats.css"],
			less=["less/ServerStats.less"]
		)
	...
	def get_update_information(self):
		...
		return dict(
			ServerStats=dict(
				displayName="Serverstats Plugin",
